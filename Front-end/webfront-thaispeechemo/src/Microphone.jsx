...
const Microphone = () => {
  ...
  const sendAudioToAPI = async (audioBlob) => {
    ...
    try {
      ...
      setAllPredictions(
        data.all_predictions || { [data.emotion]: data.confidence }
      );
    } catch (err) {
    ...
    <div className="microphone-container">
      <div className="recording-card">
        <div className="title-split">
          <div className="title-line">Voice Emotion</div>
          <div className="title-line">Analysis</div>
        </div>
            ...
            <div className="results">
              ...
              <div className="results-summary">
                <p>
                  Dominant Emotion:{" "}
                  <span
                    className={`emotion-text emotion-${(
                      emotion || ""
                    ).toLowerCase()}`}
                  >
                    {emotion}
